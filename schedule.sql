...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 30, 2017 at 08:01 PM
...
(13, 'B1', 'FRA11000', 'How to kill stident', '99', NULL);
...
CREATE TABLE `table_teacher_subject` (
  ...
  `teacher_name` varchar(100) NOT NULL,
  `subject_code` varchar(100) NOT NULL,
  `subject _name` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `table_teacher_subject` (`No`, `teacher_name`, `subject_code`, `subject _name`) VALUES
