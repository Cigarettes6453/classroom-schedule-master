<?php
  ...
  /*  หน้า user กรอกเวลาที่ไม่ว่างยังไม่ได้ทำ
   */
?>
...
<html>
  ...
  <body>
    <header>
        ...
        <div style =" margin-left:1100px; margin-top: 100px; font-size: 24px; font-family:'Work Sans', sans-serif">
        <a href="#" style=" font-size: 40px ;margin-left: 100px ; margin-top: 30px"class = "buttonsave">
                <span class = "content"><b>save</b></span>
            </a>
    </div>
        <p style = " margin-left: 600px; margin-top: -40px; font-size: 30px">total : </br></br></br></p>
  </body>
</html>
