<?php
  ...
  /*  หน้า input Doctor's degree ข้อมูลวิชา/อาจารย์ ปัจจุบันรับค่าจาก textbox ได้
      Doctor's degree,Subject Code,Subject name,Lecturer,Hours/week */
?>
<!DOCTYPE html>
<html lang="en">
  <head>
  ...
  <body>
    <header>
      ...
      <form action="admin3-D.php" method="post">
        ...
        <div style="margin-top: 50px;">
            ...
            <a href="admin3-D.php" class="btn2"style="background-color:#79a2ff"><b>Doctor's degree</b></a><br><br>
        </div>
