<?php
  ...
  /*  หน้า user ที่อาจารย์ต้องกรอกรหัสวิชา แล้วมันควรจะเด้งข้อมูลที่เก็บจาก table_teacher_subject
  Subject namespace มาจาก table_subject_description_input
  ข้อมูล  drop down sec AB รวมแยก ยังทำไม่ได้
   */
?>
...
<html>
  ...
  <body>
    <header>
        ...
        <p style =" font-family: 'Work Sans', sans-serif; font-size: 24px"> <b> Hour/week   </b>   </p></br></br>
        <div style = "margin-top: -210px; margin-left: 300px">
                ...
                <li><a href="#"style ="background: url(images/arrow.png);
                    ...
                    <ul class="item">
                        ...
                        <li><a href="#" class="forAB">A+B </a>
                            <ul class="sub-item">
                                <li><a href="#">same time</a></li>
                                <li><a href="#">different time</a></li>
          ...
          <div style =" margin-left:700px; margin-top: 100px; font-size: 24px; font-family: 'Work Sans', sans-serif"><a href="#" class = "button3">
